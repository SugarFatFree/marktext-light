...
import keybindingsDarwin from 'common/keybindings/darwin'
import keybindingsLinux from 'common/keybindings/linux'
import keybindingsWindows from 'common/keybindings/windows'
